...
protected:
    ...
    GLuint m_bufVboOpaque;
    GLuint m_bufVboTransparent;

    bool m_idxOpaqueGenerated;
    bool m_idxTransparentGenerated;
    bool m_vboOpaqueGenerated;
    bool m_vboTransparentGenerated;

public:
    InterleavedDrawable(OpenGLContext* mp_context);
    virtual ~InterleavedDrawable();

    void destroyVBOdata();

    int opaqueCount() const;
    int transparentCount() const;

    void generateIdxOpaque();
    void generateIdxTransparent();
    void generateVboQpaque();
    void generateVboTransparent();

    bool bindIdxOpaque();
    bool bindIdxTransparent();
    bool bindVboOpaque();
    bool bindVboTransparent();
};
