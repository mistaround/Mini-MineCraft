...
public:
    ...
    // funtion for outside
    void keyMovement(InputBundle&);
    BlockType addBlock(Terrain* terrian);
    BlockType removeBlock(Terrain* terrian);
    ...
    BlockType getHeadBlockType(const Terrain &terrain);
    BlockType getFeetBlockType(const Terrain &terrain);
