...
private:
    ...
    // milestone 3:
    bool m_inventoryIsOpen;
    bool m_curBlockDrawable;
...
public:
    ...
    void setCurBlockType(BlockType t);
...
signals:
    ...
    void sig_sendInventory(bool) const;
    void sig_updateInventory(BlockType bType, int num) const;
};
